...
from transformers.trainer import Trainer, TrainerState, TrainOutput, TrainerCallback, set_seed, init_deepspeed, \
    PreTrainedModel, hp_params, speed_metrics, is_torch_tpu_available, logger, DistributedSampler, DataLoader, \
    WEIGHTS_NAME, is_apex_available
...
class ExtendableTrainer(Trainer, TrainerCallback):
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        """
        :note: this is a copy of huggingface.trainer.Trainer.train that calls apply_gradients
          each time the original trainer performed optimizer step. There are no meaningful changes involved
        """
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    tr_loss[...] = self.apply_gradients(epoch, step, tr_loss, trial, steps_in_epoch,
                                                        total_train_batch_size)
